    ...
    <div className="group bg-card rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col">
      ...
      <div className="relative aspect-square bg-secondary overflow-hidden">
        ...
        <Image
          ...
          alt={product.name}
          fill
          className={`${product.imageContain ? `object-contain ${product.imageScale ?? "scale-90"} group-hover:scale-[1.18]` : "object-cover group-hover:scale-105"} transition-transform duration-500`}
